...
with open("saldo.txt", "r")as arquivo:
    ...
    if mon <= " ":
       with open("saldo.txt","w")as filee:
           ...
           time.sleep(6)
           print("aguarde estamos fazendo o passos finais do jogo para você...")
           time.sleep(6)
           print("atenção o jogo ira da um erro de codigo\nmais nais se precupa e so você entrar novamente\nque o erro vai sair")
           time.sleep(7)
           arquivo.close()
saldo = float(mon)
while True:
